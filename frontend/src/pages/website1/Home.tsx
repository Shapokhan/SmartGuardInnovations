import { HeroSection } from '@/components/website1/Hero';
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-slate-600 text-lg">
              Our nurse call systems are designed to bridge the gap between
              patients and caregivers, ensuring timely care and safety.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <div
                key={idx}
                className="group p-8 rounded-2xl bg-slate-50 hover:bg-white hover:shadow-xl transition-all duration-300 border border-slate-100"
              >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="order-1 lg:order-2">
              ...
              <p className="text-slate-600 text-lg mb-6 leading-relaxed">
                Founded by healthcare veterans and engineers, SmartGuard
                Innovations is dedicated to solving the communication
                bottlenecks in modern medical facilities.
              </p>
              <p className="text-slate-600 text-lg mb-8 leading-relaxed">
                Our systems don't just alert staff—they provide context,
                priority, and confirmed delivery, ensuring that critical patient
      ...
      <section className="py-24 bg-primary relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 md:px-6 relative z-10 text-center">
          ...
          <p className="text-blue-100 text-lg md:text-xl max-w-2xl mx-auto mb-10">
            Get a free consultation and demo of our nurse call systems. See how
            much efficient your team can be.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button
              size="lg"
              variant="secondary"
              className="rounded-full px-10 h-14 text-primary font-bold text-lg hover:bg-white"
            >
              Request Demo
            </Button>
            <Button
              size="lg"
              variant="outline"
              className="rounded-full px-10 h-14 text-black border-white/30 hover:bg-white/10 font-bold text-lg hover:text-white"
            >
              Contact Sales
            </Button>
          </div>

                    ...
                    <div className="container mx-auto px-4 relative z-10">
                        ...
                        <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
                            <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-[#053131] leading-tight">
                                <span className="font-bold">Comprehensive</span> <span className="font-light font-soka text-[#0C6E6D]">Solutions</span><br />
                                <span className="text-2xl sm:text-3xl font-light text-gray-500">Tailored for your business growth</span>
                            </h2>
                            <p className="text-gray-500 text-sm sm:text-base leading-relaxed">
                                We offer a wide range of services designed to help you achieve your business goals. From strategic consulting to digital transformation, we have the expertise to drive your success.
                            </p>
                        </div>
